...
export const create = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(selectOrdersSchema, "Create an order"),
...
export const patch = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(selectOrdersSchema, "Update an order"),
    [HttpStatusCodes.NOT_FOUND]: jsonContent(notFoundSchema, "Order not found"),
...
export const isUserInActiveOrder = createRoute({
  ...
  request: {
    body: jsonContentRequired(
      z.object({
        order_id: z.string().nonempty("Order id is required").pipe(z.string().uuid()),
        user_id: z.string().nonempty("User id is required").pipe(z.string().uuid()),
      }),
      "Order and user id"
    ),
  },
